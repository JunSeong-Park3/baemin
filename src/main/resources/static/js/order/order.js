...
//		7/26일 주문하기 주소 text 추가
		testAddress2: $(".testAddress2").val(),
		deliveryAddress3: $("#deliveryAddress3").val(),
		totalPrice: $("#total").val()
	}
	console.log("deliveryAddress1 : " + data.deliveryAddress1);
	console.log("deliveryAddress2 : " + data.deliveryAddress2);
	console.log("deliveryAddress3: " + data.deliveryAddress3);
