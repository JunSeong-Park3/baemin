		...
		<li class="delivery_cont">
			...
			<div class="delivery_info">
				...
				<div>
					<span>주소 :</span> 
					<span class="address1">
<!-- 	7/26일 추가 id 및 style 추가 home.js and order.js 부분 수정 -->
					<input type="text"  style="width:280px; text-align:center;" id="address1" class="testAddress2"  name="testAddress2" value="" readonly>
					</span> 
					<button type="button" onclick="execution_daum_address()" id="delivery_modify" >주소 변경하기</button>
                  <!--  	7/22 주석 품 -->
<%-- 	    7월22일 기존대로 다시 주석         	<%@ include file="/WEB-INF/views/layout/modifyAddress.jsp" %> --%>
				</div>
    ...
    <!-- 하단 메뉴 -->
<%--    7월22일 기존대로 다시 주석	<%@ include file="/WEB-INF/view/include/nav.jsp" %> --%>
    <!-- 하단 메뉴 -->
